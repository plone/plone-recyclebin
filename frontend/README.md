# Plone Recycle Bin (volto-recyclebin)

A recycle bin for Plone

[![npm](https://img.shields.io/npm/v/volto-recyclebin)](https://www.npmjs.com/package/volto-recyclebin)
[![](https://img.shields.io/badge/-Storybook-ff4785?logo=Storybook&logoColor=white&style=flat-square)](https://plone.github.io/volto-recyclebin/)
...
Add `volto-recyclebin` to your `package.json`.
...
Add `volto-recyclebin` to your `volto.config.js`.
...
yo @plone/volto my-volto-project --addon volto-recyclebin
cd my-volto-project
```
