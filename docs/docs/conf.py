...
# Plone Recycle Bin build configuration file
...
htmlhelp_basename = "Plone Recycle BinDocumentation"
...
latex_documents = [
    (
        "index",
        "Plone Recycle BinDocumentation.tex",
        "Plone Recycle Bin Documentation",
        "plone community",
        "manual",
    ),
]
